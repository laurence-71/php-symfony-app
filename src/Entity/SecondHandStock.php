...
/**
 * @ORM\Entity(repositoryClass=SecondHandStockRepository::class)
 */
class SecondHandStock
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Requirement::class, inversedBy="secondHandStocks")
     */
    private $requirement;

    /**
     * @ORM\ManyToOne(targetEntity=Recycling::class, inversedBy="secondHandStocks")
     */
    private $recycling;
